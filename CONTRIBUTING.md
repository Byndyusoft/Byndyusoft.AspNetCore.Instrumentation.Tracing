# Contributing to Byndyusoft.AspNetCore.Instrumentation.Tracing
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.AspNetCore.Instrumentation.Tracing code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.AspNetCore.Instrumentation.Tracing.git
```
